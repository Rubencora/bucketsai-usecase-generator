    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-page-bg">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04),0_8px_24px_rgba(68,112,220,0.08)] border border-brand-border p-8">
          <h2 className="text-xl font-bold text-brand-navy-text mb-6 text-center">Iniciar sesion</h2>
          ...
          <p className="text-center mt-4">
            <button onClick={() => router.push('/forgot-password')} className="text-sm text-brand-blue font-semibold hover:text-brand-blue-med cursor-pointer">
