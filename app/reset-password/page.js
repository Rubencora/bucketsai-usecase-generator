...
function ResetForm() {
  ...
  return done ? (
    <div className="text-center">
      ...
      <h2 className="text-xl font-bold text-brand-navy-text mb-2">Contrasena actualizada</h2>
      <p className="text-brand-text-muted text-sm mb-6">Ya puedes iniciar sesion con tu nueva contrasena.</p>
      <button
    ...
    <>
      <h2 className="text-xl font-bold text-brand-navy-text mb-6 text-center">Nueva contrasena</h2>
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label htmlFor="password" className="block text-sm font-semibold text-brand-navy-text mb-2">Nueva contrasena</label>
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 text-brand-gray-mid hover:text-brand-navy-text cursor-pointer"
              tabIndex={-1}
            >
              {showPassword ? (
